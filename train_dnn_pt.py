...
X_train_val, X_test, y_train_val, y_test = train_test_split(features, targets, test_size=0.3, random_state=690)
...
LAYER_SIZES = [X_train.shape[1], 124, 100, 80, 60, 40, 3]  # Include input size and output size
