...
pca_svm_pipeline = Pipeline([
    ('pca', PCA(n_components=5)),  # Best number of components as found by the grid search
    ('svm', SVC(C=0.1, kernel='rbf', gamma='scale'))  # Best SVM parameters from the grid search
])
...
plt.title('1000 Seeds in a Pipelined PCA + SVM Model')
